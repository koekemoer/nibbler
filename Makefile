...
LINUX_FLAGS = -Wno-deprecated -lSDL2 -lSDL2_image -lSDL_image -lGL -lsfml-graphics -lsfml-window -lsfml-system
...
$(NAME):
	...
	$(CC) $(CFLAGS)  $(SRC) -I gfx/sdl2/ $(LINUX_FLAGS) -L . -l1 -L . -l2 -o $(NAME) -ldl
